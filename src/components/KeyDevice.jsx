...
async function handleFetch() { //funcao assincrona que chama a API
setError(null); // reseta o erro
setData(null); // reseta os dados


// valida se a URL base e a chave foram fornecidas
if (!baseUrl || !keyValue) { // se um dos dois estiver vazio
...
try {
  ...
  if (!res.ok) { // se a resposta nao for ok
    throw new Error(`Chave nao encontrada. Status: ${res.status}`);
  }
